...
namespace Auden.AudenHelper
{
    ...
    public class BaseClass
    {
        ...
        public static LoanFormPage GivenINavigateToAudenWebsite()
        {
            LaunchUrl("https://www.auden.co.uk/Credit/ShortTermLoan");

            return new LoanFormPage();
